...
class AdditionalInputHTPacemaker(AbstractAdditionalInput):
    ...
    def __init__(self, n_neurons,
       # Pacemaker
       I_H, g_H, E_H, m_H, m_inf_H, e_to_t_on_tau_m_H, 
       # Calcium
       I_T, g_T, E_T, m_T, m_inf_T, e_to_t_on_tau_m_T, h_T, h_inf_T, e_to_t_on_tau_h_T,
       # Sodium 
       I_NaP, g_NaP, E_NaP, m_inf_NaP, 
       # Potassium
       I_DK, g_DK, E_DK, m_inf_DK, e_to_t_on_tau_m_DK, D, D_infinity, 
       # Voltage Clamp
