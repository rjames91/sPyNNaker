...
class SynapseDynamicsDvDt(
    ...
    def is_same_as(self, synapse_dynamics):
        ...
        if not isinstance(synapse_dynamics, SynapseDynamicsDvDt):
            return False
        return (
    ...
    def get_vertex_executable_suffix(self):
        name = "_plastic" # ...lif..._dv + _plastic
        return name
    ...
    def get_plastic_synaptic_data(
        ...
        type_mask = (1 << n_synapse_type_bits) - 1
        id_mask = (1 << n_neuron_id_bits) - 1
        ...
        fixed_plastic = (
            ...
            ((connections["synapse_type"].astype("uint16") & type_mask)
             << n_neuron_id_bits) |
            (((connections["target"].astype("uint16") -
               post_vertex_slice.lo_atom) & id_mask)))
    ...
    def read_plastic_synaptic_data(
        ...
        connections["target"] = (data_fixed & neuron_id_mask) + post_vertex_slice.lo_atom
