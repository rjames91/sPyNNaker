...
static input_t additional_input_get_input_value_as_current(
	...
	additional_input->e_to_t_on_tau = 0.367879k; // exp(-0.1/1250)
	...
	additional_input->D = additional_input->D_infinity +
                             ...
                             * additional_input->e_to_t_on_tau;
       
        accum D_cube = (additional_input->D-0.05) * (additional_input->D-0.05) *  (additional_input->D-0.05);  // the 0.05 factor was added to compensate the difference from 3.5 to 3.0 exponent, in this way the error is minimal.
